...
public class TileEntityTestMachine extends TileEntity implements ITickable {

    private static final int SLOTS_SIZE = 6;
    ...
    private ItemStackHandler inventoryIO = new ItemStackHandler(SLOTS_SIZE){
        ...
        public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate) {
            if (slot == ContainerTestMachine.ORE) {
        ...
        public ItemStack extractItem(int slot, int amount, boolean simulate) {
            if (slot == ContainerTestMachine.PRODUCT) {
